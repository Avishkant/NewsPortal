...
import { Link, useNavigate } from "react-router-dom"; // useNavigate added for potential redirection
import { useAuth } from "../contexts/AuthContext.jsx";
import { apiFetch } from "../api.js";
import NewsCard from "../components/NewsCard.jsx"; // Assuming NewsCard is styled
import { motion } from "framer-motion";
import { FaNewspaper, FaFilter, FaAngleDown, FaTachometerAlt } from "react-icons/fa";
...
export default function NewsList() {
  ...
  return (
    <div className="p-6 md:p-10 min-h-screen bg-gray-50">
      ...
      {/* --- News Grid --- */}
      {loading ? (
        <div className="text-center p-10 text-gray-500">Loading articles...</div>
      ) : items.length === 0 ? (
